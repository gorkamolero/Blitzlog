...
const getPosts = (req, res) => { res.json(posts.posts) }

const getOnePost = (req, res) => {
  const {slug} = req.params
  const currentPost = posts.posts.find(post => post.slug == slug)
  res.send(currentPost)
}

app.get('/', (req, res) => res.send('Hello World!'))
app.get('/api/posts/', getPosts)
app.get('/api/posts/:slug', getOnePost)
